...
<td align="center" valign="top" width="25%" style="background-color:#e8eaed;padding:10px 8px;color:#1f2328"><img src="svg/eye.svg" width="36" height="36" alt="eye" style="filter:invert(29%) sepia(5%) saturate(0%) hue-rotate(201deg) brightness(96%) contrast(90%)" /><br /><sub><code style="color:#1f2328;font-size:0.75em">ei-eye</code></sub></td>
...
<tr>
<td align="center" valign="top" width="25%" style="background-color:#e8eaed;padding:10px 8px;color:#1f2328"><img src="svg/play.svg" width="36" height="36" alt="play" style="filter:invert(29%) sepia(5%) saturate(0%) hue-rotate(201deg) brightness(96%) contrast(90%)" /><br /><sub><code style="color:#1f2328;font-size:0.75em">ei-play</code></sub></td>
